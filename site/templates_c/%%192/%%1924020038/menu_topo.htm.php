...
<header class="sidenav" id="sidenav">
  ...
  <div class="socials sidenav__socials">
    <a class="social social-facebook" href="https://web.facebook.com/FET_F%C3%B3rum-de-Educa%C3%A7%C3%A3o-e-Tecnologia-1850524181922234/" target="_blank" aria-label="facebook"><i class="ui-facebook"></i></a>
      ...
      <div class="flex-parent">
        ...
        <nav class="flex-child nav__wrap d-none d-lg-block">
          <ul class="nav__menu">
            ...
            <li <?php if ($this->_tpl_vars['secao'] == 'dashboard'): ?> class="active" <?php endif; ?> >
              <a href="index.php">Home</a>
            
            </li>
            
            <li <?php if ($this->_tpl_vars['secao'] == 'noticia'): ?> class="active" <?php endif; ?> >
              <a href="index.php?secao=noticia&modulo=lista">Noticias</a>
            </li>
            
            <li <?php if ($this->_tpl_vars['secao'] == 'palestra'): ?> class="active" <?php endif; ?> >
              <a href="index.php?secao=palestra&modulo=lista">Palestras</a>
            </li>

            <li <?php if ($this->_tpl_vars['secao'] == 'oficina'): ?> class="active" <?php endif; ?> >
              <a href="index.php?secao=oficina&modulo=lista">Oficinas</a>
            </li>
        ...
        <div class="nav__right nav--align-right d-lg-flex">
          <div class="nav__right-item socials nav__socials d-none d-lg-flex">
            <a class="social social-facebook social--nobase" href="https://web.facebook.com/FET_F%C3%B3rum-de-Educa%C3%A7%C3%A3o-e-Tecnologia-1850524181922234/" target="_blank" aria-label="facebook"><i class="ui-facebook"></i></a>
