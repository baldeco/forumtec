<?php /* Smarty version 2.6.1, created on 2018-10-17 20:18:05
         compiled from palestra_detalhes.htm */ ?>
  ...
  <div class="row">
    ...
    <div class="col-lg-8 blog__content mb-30">
      ...
      <article class="entry">
        ...
        <!-- Local -->
        <h6 class="uppercase">Local: <?php echo $this->_tpl_vars['a_palestra']['nome_local']; ?>
...
" alt="" class="entry__img">
        ...
        <?php if ($this->_tpl_vars['a_palestra']['anexo']): ?>
        <div>
          <a href="<?php echo $this->_tpl_vars['a_palestra']['anexo']; ?>
" download="download"><button style="background-color: #CD9B1D;" class="btn btn-lg btn-color btn-button"><?php echo $this->_tpl_vars['a_palestra']['legendaAnexo']; ?>
</button></a>
        </div>
        <?php endif; ?>

        <?php if ($this->_tpl_vars['a_palestra']['disponivel'] == 's'): ?>
        <div>
          <a href="index.php?secao=inscricao&modulo=palestra&id_palestra=<?php echo $this->_tpl_vars['a_palestra']['id_palestra']; ?>
"><button class="btn btn-lg btn-color btn-button">INSCREVER-SE</button></a>
        ...
        <div class="title-wrap mt-40">
          <h5 class="uppercase">PALESTRANTES</h5>
        </div>

        <div>
          <?php if (count($_from = (array)$this->_tpl_vars['a_palestra']['palestrantes'])):
