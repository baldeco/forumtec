...
$id_participane = buscarIDParticipantePorEmail($a_dados['email']);
if ($id_participane == false) exit('Participante não cadastrado!');
...
$checkin = buscarCheckin($id_palestra, $id_participane);
if ($checkin == false) exit('Participante não cadastrado!');
